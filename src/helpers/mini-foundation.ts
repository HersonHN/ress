...
function init(_ = document) {
  // search for all controls
  // initiateControls(parent);
  console.log('@TODO init mini-foundation');
}

// function initiateControls(parent: Element) {
//   let $controls = $.find('[data-open]', parent);

//   $controls.forEach(function (trigger) {
//     let targetId = String(trigger.getAttribute('data-open'));
...
// function setup(trigger: Element, control) {
...
// function guessType(target: Element) {
//   let conf;
